...
//       customShader: ShaderMaterial & { key: string; iTime: number };
//     }
//   }
// }
...
const Home: NextPage = () => {
  ...
  //   {
  //     iTime: 0,
  //     iResolution: new Vector3(window.innerWidth, window.innerHeight, 0),
  //   },
  //   '',
...
void main()
{
  ...
  return (
    <Canvas style={{ width: 100, height: 100 }}>
      <mesh>
        <boxGeometry args={[5, 5, 1, 64, 64, 1]} />
        <shaderMaterial
          ref={ref}
          attach='material'
